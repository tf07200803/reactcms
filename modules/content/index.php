...
class index {
	...
	public function show() {
        ...
        if(empty($previous_page)) {
            $previous_page = array('title'=>'empty', 'thumb'=>IMG_PATH.'nopic_small.gif', 'url'=>'javascript:alert(\''.L('first_page').'\');');
        }

        if(empty($next_page)) {
            $next_page = array('title'=>'empty', 'thumb'=>IMG_PATH.'nopic_small.gif', 'url'=>'javascript:alert(\''.L('last_page').'\');');
        }

        $data['prev']=$previous_page;
        $data['next']=$next_page;
